...
function updateCounters() {
  ...
  if (elTotal)   elTotal.textContent   = document.querySelectorAll('tr[data-pubkey]').length;
  if (elActive)  elActive.textContent  = document.querySelectorAll('tr[data-pubkey]:not([data-blocked="true"])').length;
  if (elBlocked) elBlocked.textContent = document.querySelectorAll('tr[data-pubkey][data-blocked="true"]').length;
}
